...
export default function AmazonSignup() {
  ...
  const handleRegister = async () => {
    ...
    try {
      const res = await registerUserAPI({ username: form.username, email: form.email, phone: form.phone, password: form.password });
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <div className="bg-white border border-gray-300 rounded px-7 py-5 w-full max-w-sm mb-5">
        <h1 className="text-3xl font-normal mb-3">Create Account</h1>
        
        <div>
          <div className="mb-3">
            <label htmlFor="username" className="block text-sm font-bold mb-1 text-gray-900">
              Username
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="phone" className="block text-sm font-bold mb-1 text-gray-900">
              Phone
            </label>
            <input
              type="tel"
          ...
          <button
            ...
            disabled={loading}
            className={`w-full h-8 bg-gradient-to-b from-yellow-200 to-yellow-400 border border-yellow-600 rounded text-sm text-gray-900 hover:from-yellow-300 hover:to-yellow-500 mt-3 shadow-sm ${loading ? 'opacity-60 cursor-not-allowed' : ''}`}
          >
            Register
          </button>
          ...
          <div className="mt-5 text-sm">
            ...
            <a href="/login" className="text-blue-600 hover:text-orange-700 hover:underline">
              Sign in ›
            </a>
          </div>

          <div className="text-xs text-gray-900 mt-5 leading-relaxed">
      ...
      <button className="w-full max-w-sm h-8 bg-white border border-gray-300 rounded text-sm text-gray-900 hover:bg-gray-50 flex items-center justify-center gap-2 shadow-sm mb-8">
      ...
      <footer className="mt-auto pt-5 pb-5 text-center w-full border-t border-gray-300">
